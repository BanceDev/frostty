...
impl Default for ColorPalette {
    fn default() -> Self {
        Self {
            ...
            red: String::from("#e64747"),
            green: String::from("#42e66c"),
            yellow: String::from("#e4f34a"),
            blue: String::from("#9b6bdf"),
            magenta: String::from("#e356a7"),
            cyan: String::from("#75d7ec"),
            white: String::from("#f8f8f2"),
            bright_black: String::from("#7a7a7a"),
            bright_red: String::from("#ff5555"),
            bright_green: String::from("#50fa7b"),
            bright_yellow: String::from("#f1fa8c"),
            bright_blue: String::from("#bd93f9"),
            bright_magenta: String::from("#ff79c6"),
            bright_cyan: String::from("#8be9fd"),
            bright_white: String::from("#f9f9fb"),
            bright_foreground: None,
            dim_foreground: String::from("#f8f8f2"),
            dim_black: String::from("#262626"),
            dim_red: String::from("#e64747"),
            dim_green: String::from("#42e66c"),
            dim_yellow: String::from("#e4f34a"),
            dim_blue: String::from("#9b6bdf"),
            dim_magenta: String::from("#e356a7"),
            dim_cyan: String::from("#75d7ec"),
            dim_white: String::from("#f8f8f2"),
        }
    }
}
